...
2.  Clone the [cs61-psets repository][repo] onto your computer.
...
$ ./cs61-run-docker
cs61-user@04e3abfc6c5e:~/cs61-psets$ uname
Linux
cs61-user@04e3abfc6c5e:~/cs61-psets$ uname -a
Linux 04e3abfc6c5e 6.10.4-linuxkit #1 SMP PREEMPT_DYNAMIC Sat May 17 08:28:57 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
cs61-user@04e3abfc6c5e:~/cs61-psets$ ls
cs61-run-docker  docker  pset0  README.md
cs61-user@04e3abfc6c5e:~/cs61-psets$ exit
exit
$ 
```

A prompt like `cs61-user@04e3abfc6c5e:~$` means that your terminal is
connected to the VM. (The `04e3abfc6c5e` part is a unique identifier for this
...
* `-v LOCALDIR:LINUXDUR` says Docker should share a directory between your
  ...
  `~/cs61-psets` directory to be mapped inside the virtual machine onto the
  `/home/cs61-user/cs61-psets` directory, which is the virtual machine
  user’s `~/cs61-psets` directory.
